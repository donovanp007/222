...
import { Search, Filter, Calendar, User, FileText, CreditCard, X } from "lucide-react";
...
export function AdvancedSearch({ onSelectResult }: AdvancedSearchProps) {
  ...
  }, [query, searchInName, searchInContent, searchInDiagnosis, searchInMedicalAid, dateRange, selectedSessionType]);
